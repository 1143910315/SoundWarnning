 ...
 */
public class AudioRecorder_back {
    public interface RecordStreamListener {
        void recordOfByte(byte[] audioData, int i, int length);
    }
    ...
    private static class AudioRecorderHolder {
         ...
         * 静态初始化器，由JVM来保证线程安全
         */
        private static AudioRecorder_back instance = new AudioRecorder_back();
    }

    private AudioRecorder_back() {
    }

    public static AudioRecorder_back getInstance() {
